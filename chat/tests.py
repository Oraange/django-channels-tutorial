...
class ChatTests(ChannelsLiveServerTestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            cls.driver = webdriver.Chrome('/Users/songchiheon/Downloads/chromedriver')
        except:
            super().tearDownClass()
            raise
    ...
    def _open_new_window(self):
        self.driver.execute_script('window.open("about:blank", "_blank");') # 새로운 탭(윈도우) 생성
        self._switch_to_window(-1) # 가장 마지막 탭(윈도우)으로 이동
